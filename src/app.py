...
async def process_frame(frame_file: UploadFile):
    ...
    for result in results:
        ...
        for box, class_index in zip(boxes, classes):
            ...
            out_frame[ymin:ymax, xmin:xmax, :] = raw_frame[ymin:ymax, xmin:xmax, :]
    ...
    _, out_buff_array = cv2.imencode(".png", out_frame)
    out_bytes = BytesIO(out_buff_array.tobytes())
    out_bytes.seek(0)
